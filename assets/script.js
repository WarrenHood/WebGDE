...
loadfunc = function(){
  ...
  element_head.style.width = window.innerWidth*0.35 - 2 + "px";
  element_head.style.height = window.innerHeight*0.05 - 2 + "px";
  element_head.style.left = window.innerWidth*0.35 + 1 + "px";
  element_search.style.height = window.innerHeight*0.04 - 2 + "px";
  element_search.style.width = window.innerWidth*0.35 - 2 + "px";
  element_search.style.top = window.innerHeight*0.05 + 1 + "px";
  element_search.style.left = window.innerWidth*0.35 + 1 + "px";
  element_pane.style.width = window.innerWidth*0.35 - 2 + "px";
  ...
  preview_pane.style.width = window.innerWidth*0.35 - 2 + "px";
